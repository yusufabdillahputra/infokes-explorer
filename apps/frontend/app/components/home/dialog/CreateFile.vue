...
const {createFileActionDialog} = useFolderService()
const {listSub} = useFolderRepository();
const store = useCreateFileDialogStore()
  ...
  >
    <DialogContent class="sm:max-w-[425px]">
      <DialogHeader>
        ...
        <DialogDescription>
          Create your file here. Click save when you're done.
        </DialogDescription>
      </DialogHeader>
